var alignmentFns = {
    ...
    init: function(input, step, max, min, digit) {
        ...
        input.css("width", "1.6rem");
        input.css("height", ".9rem");
		input.css("font-size", ".4rem");
        input.css("padding", "0px");
        input.css("margin", "0px");
        input.css("text-align", "center");
        input.css("vertical-align", "middle");
        input.css("line-height", "1rem");
        input.wrap("<div id = '" + input.attr('id') + "div' style = 'overflow:hidden;width:3.8rem;font-size:.5rem;height:.9rem;border: 1px solid #CCC;'></div>");
        input.before("<div id = '" + input.attr('id') + "l'  onselectstart = 'return false;' style = '-moz-user-select:none;cursor:pointer;text-align:center;width:1rem;height:.9rem;line-height:.9rem;border-right: 1px solid #CCC;float:left'>-</div>");
        input.after("<div id = '" + input.attr('id') + "r'  onselectstart = 'return false;' style = '-moz-user-select:none;cursor:pointer;text-align:center;width:1rem;height:.9rem;line-height:.9rem;border-left: 1px solid #CCC;float:right'> + </div>");
